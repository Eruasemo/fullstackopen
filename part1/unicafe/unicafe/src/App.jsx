...
const DisplayStatistic = ({ text, quantity }) => <tr><th>{text}</th><td>{Math.round(quantity * 100) / 100}</td></tr>
const DisplayPercentage = ({ text, quantity }) => <tr><th>{text}</th><td>{quantity.toFixed(2)} %</td></tr>
